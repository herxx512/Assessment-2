...
// console.log(canWeDeliver(90542))
...
//CODE HERE
const dealChange = deals[0].title.replace('15','10')
// console.log(dealChange)
deals[0].title = dealChange
...
//CODE HERE
const desChange = deals[1].desc.replace('March','April').trim()
//console.log(desChange)
deals[1].desc = desChange



//Console Log of the full changes:
//console.log(deals)
